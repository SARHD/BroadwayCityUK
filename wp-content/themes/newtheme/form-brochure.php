<div class="container-fluid my-5 w-100 w-md-50 mw-550">
    <form id="customForm" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" enctype="multipart/form-data" novalidate>
        ...
        <div class="d-flex justify-content-center">
            <button type="button" class="btn-submit formbutton-submit" onclick="submitForm()">View Brochure Now</button>
        </div>
    </form>
</div>
        ...
        fetch(adminUrl, {
            ...
            .then((result) => {
                if (result.trim() === 'success') {
                    ...
                    window.location.href = 'https://storage.googleapis.com/msgsndr/htjPoFlEFNozFOmJesqe/media/6346fb9c31b6e0e2b7b10bd4.pdf';
                } else {
